...
HD_PWD='C:/Xilinx/projects/T20_cricket_game/T20_cricket_game.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cricket_topmodule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cricket_topmodule.tcl
